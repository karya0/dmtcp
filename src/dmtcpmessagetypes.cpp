...
void
WorkerState::setCurrentState(const WorkerState &theValue)
{
  instance() = theValue;
}
...
WorkerState::eWorkerState
WorkerState::value() const
{
...
ostream &
dmtcp::operator<<(dmtcp::ostream &o, const WorkerState &s)
{
  o << "WorkerState::";
  switch (s.value()) {
