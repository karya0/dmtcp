...
static char *request_names[NUM_TUN_REQUEST_TYPES] = {
  ...
  "TUNSETOFFLOAD",   "TUNSETTXFILTER", /* Can only be set for TAP */
  "TUNSETSNDBUF",    "TUNATTACHFILTER", /* Can only be set for TAP */
