...
static const char file_names_1[NUM_OF_FILES]
                              [FILENAME_LEN] = { "bake_0", "bake_1", "bake_2" };
static const char file_names_2[NUM_OF_FILES]
                              [FILENAME_LEN] = { "Samm_3", "Samm_4", "Samm_5" };
